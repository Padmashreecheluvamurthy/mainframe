...
/*Object creation for utilities*/
		...
		String industry = elib.getDataFromExcel("org", 1, 2);
...
driver.findElement(By.xpath("//input[@title='Save [Alt+S]']")).click();
		...
		String actHeadr1 = driver.findElement(By.id("dtlview_Industry")).getText();
		if(actHeadr1.contains(industry))
		{
